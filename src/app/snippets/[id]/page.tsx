            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="border border-green-800 bg-black/80 p-6 rounded-none shadow-[0_0_20px_#00ff00]">
                    <h1 className="text-2xl font-bold text-green-300 mb-2 tracking-wide uppercase">
                      {snippet.title}
                    </h1>
                    <div className="text-sm text-green-600 flex flex-wrap gap-4">
                      <span><User className="inline w-4 h-4"/> {snippet.userName}</span>
                      <span><Clock
                          className="inline w-4 h-4"/> {new Date(snippet._creationTime).toLocaleDateString()}</span>
                      <span><MessageSquare className="inline w-4 h-4"/> {comments?.length} comments</span>
                    </div>
                  </div>
              ...
              <div
                  className="inline-flex items-center px-3 py-1.5 bg-[#ffffff08] text-[#808086] rounded-lg text-sm font-medium">
                {snippet.language}
              </div>
            </div>
          </div>
